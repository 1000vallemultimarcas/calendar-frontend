...
const ModalContent = ({
	...
	return (
		<ModalPortal>
			...
			>
				{children}
				<ModalClose className="absolute right-4 top-4 rounded-sm bg-orange-600 p-1 text-white opacity-100 ring-offset-background transition-colors hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:pointer-events-none">
					<X className="h-4 w-4" />
